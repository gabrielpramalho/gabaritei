<x-app-layout>
    ...
    <div class="flex-wrap items-center justify-center gap-8 text-center  sm:flex pt-6 pb-14">
        <div class="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/4 dark:bg-gray-800">
            <div class="flex-shrink-0">
                <div class="flex items-center justify-center w-12 h-12 mx-auto text-white bg-emerald-600 rounded-md">
