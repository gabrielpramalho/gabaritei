...
<div class=" bg-gray-100 p-0 sm:p-6">
  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    <h1 class="text-2xl font-bold mb-8 text-center">Enviar Cartão-Resposta</h1>
    <form id="form" method="POST" action="/corrigir-prova" enctype="multipart/form-data"  >
      @csrf
      <div class="relative z-0 w-full mb-5">
          ...
          >
            ...
            @foreach ($gabaritos as $gabarito)
                <option value="{{ $gabarito->id }}">{{ $gabarito->nome }}</option>
            @endforeach


          </select>
          <label for="select" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Selecione o gabarito</label>
      ...
      <div class="relative z-0 w-full mb-5">
        ...
        />
        <label for="prova" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">Cartões-respostas</label>
