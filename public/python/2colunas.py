...
#   print(x1,x2, col)
  ...
  if col == "coluna1":
    if x1 > 180 and x2 < 205:
      return "A"
    elif x1 > 210 and x2 < 240:
      return "B"
    elif x1 > 235 and x2 < 265:
      return "C"
    elif x1 > 260 and x2 < 290:
      return "D"
    elif x1 > 280 and x2 < 310:
      return "E"
  elif col == "coluna2":
    if x1 > 380 and x2 < 420:
      return "A"
    elif x1 > 420 and x2 < 450:
      return "B"
    elif x1 > 440 and x2 < 480:
      return "C"
    elif x1 > 470 and x2 < 500:
      return "D"
    elif x1 > 500 and x2 < 530:
      return "E"

  else:
    return "X"

def concatenate_questions(id, col1, col2):
  questions = list()
  questions.append(id)
...
total = concatenate_questions(barcode, coluna1, coluna2)
# print(total)
